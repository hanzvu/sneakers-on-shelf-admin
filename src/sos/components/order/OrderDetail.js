                    ...
                    <Box p={{ xs: 1, md: 3 }}>
                        ...
                        <Grid container justifyContent={"space-between"} pb={1} alignItems="center">
                            <Stack direction={"row"} spacing={2} pt={1}>
                                ...
                                <OrderStatusDialog hidden={(data.transactions.paymentAmount - data.transactions.reverseAmount < data.requiredAmount) || (data.orderStatus.name !== "CONFIRMED" && data.orderStatus.name !== "SHIPPING") || (data.orderStatus.name !== 'SHIPPING' && data.saleMethod.name === 'DELIVERY')} color="secondary" buttonTitle={"HOÀN THÀNH"} dialogTitle="Xác Nhận Hoàn Thành" onSubmitEvent={orderStatusOnChange} value="APPROVED" required />
                            </Stack>
